...
## Workshop focus areas related to Bridge Structural Health Monitoring
- ```Data Management```: Data security and quality; Intellectual Property; Standards and Shared Best Practices; Curation  
- ```Decision Support Systems```: Analysis and Modeling; Data Analytics; Decision Making; Visualization  
- ```Social-Technological Impact```: Policy, societal, economic and environmental impact; disaster and crisis management   
- ```Next-Gen Health Monitoring```: Unmanned Aerial Vehicle/System(UAV/UAS); Sensors; Wireless Networks  
